        ...
        <div class="list-wrapper">
          <div v-for="item in notice" :key="item.id" class="list-item">
            ...
            <div class="list-item-body">
              <eui-ellipsis>{{ item.title }}</eui-ellipsis>
              <eui-ellipsis type="placeholder" class="list-item-text">
                {{ item.time }}
              </eui-ellipsis>
            </div>
          </div>
...
<script lang="ts" setup>
  ...
  import type { EuiTabs } from 'eui-admin-kit/es';
  import {
    Comment,
    Stamp,
    Promotion,
  ...
  /** 标签页 */
  const tabRef = ref<InstanceType<typeof EuiTabs> | null>(null);
