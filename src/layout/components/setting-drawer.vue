...
<template>
  ...
  >
    <div :class="['setting-wrapper', { 'setting-dark': darkMode }]">
      ...
      <el-divider />
      <!-- 导航布局 -->
      <eui-text type="placeholder" class="setting-title">
      ...
      <div style="padding-top: 6px">
        <el-button size="small" class="eui-fluid" @click="resetSetting">
...
<script lang="ts" setup>
  ...
  const updateDarkMode = (isDark: boolean) => {
    ...
    const rect = darkSwitchRef.value.getBoundingClientRect();
    ...
    const trigger = darkSwitchRef.value;
