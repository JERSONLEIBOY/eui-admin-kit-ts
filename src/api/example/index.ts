...
import messageData from '@/assets/json/message.json';
import noticesData from '@/assets/json/notices.json';
import lettersData from '@/assets/json/letters.json';
import todosData from '@/assets/json/todos.json';
/**
 * 查询未读通知
 */
export async function getUnreadNotice(): Promise<NoticeResult> {
  return messageData as unknown as NoticeResult;
}
...
export async function pageNotices(_params: any) {
  return noticesData as unknown as NoticeResult;
}
...
export async function pageLetters(_params: any) {
  return lettersData as unknown as NoticeResult;
}
...
export async function pageTodos(_params: any) {
  return todosData as unknown as NoticeResult;
}
